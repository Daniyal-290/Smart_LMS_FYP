    ...
    <div className="min-h-screen bg-slate-100 py-10 px-6">
      ...
      <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
        ...
        <button
          ...
          className="mt-10 w-full py-3 rounded-xl bg-slate-700 text-white font-semibold hover:bg-slate-800 transition disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {loading ? <Loader2 size={18} className="animate-spin" /> : null}
          {loading ? "Grading..." : submitted ? "Quiz Submitted" : "Submit Quiz"}
        </button>
