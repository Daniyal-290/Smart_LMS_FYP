            ...
            <tbody>
              {filtered.map((f) => (
                <tr key={f.id} className="border-b border-slate-100 last:border-0">
                  ...
                  <td className="py-4">
                    <button className="flex items-center gap-1.5 bg-slate-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-700 transition cursor-pointer">
                      <Eye size={15} />
                      Review
                    </button>
                  </td>
