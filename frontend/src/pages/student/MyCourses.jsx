...
export default function MyCourses() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch ALL available courses (assuming admin/instructor creates them)
      // Since student only has access to /api/courses which returns enrolled courses,
      // wait, the backend doesn't have an /api/courses/available route for students!
      // Let's just fetch all courses if the backend allows, or use the existing route.
      // I'll update the backend route /api/courses/all to allow students too.
