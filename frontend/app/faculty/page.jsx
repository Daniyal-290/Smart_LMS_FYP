  ...
  return (
    ...
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/faculty/plagiarism" className="text-sm font-medium text-slate-500 hover:text-slate-800 transition">
          All detections
        </Link>
      </div>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                "
              >
                {loadingIds[flag.id] ? <Loader2 size={15} className="animate-spin" /> : <Eye size={15} />}
                {loadingIds[flag.id] ? "Loading..." : "Review"}
              </button>
  ...
  return (
    ...
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          <Link href="/faculty/mid-term-reports" className="text-sm font-medium text-slate-500 hover:text-slate-800 transition">
            View all
          </Link>
          <button
