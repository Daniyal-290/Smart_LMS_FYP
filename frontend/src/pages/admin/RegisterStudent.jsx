      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative border-b-2 border-slate-200 focus-within:border-amber-500 transition-colors">
          ...
          <input
            ...
            required
            className="w-full bg-transparent pl-8 py-3 outline-none text-slate-800 placeholder-slate-500"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-[#f5b842] hover:bg-[#e0a631] text-slate-900 font-semibold px-6 py-4 rounded-xl mt-6 transition-colors shadow-sm disabled:opacity-50"
        >
