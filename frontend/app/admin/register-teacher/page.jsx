  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 max-w-2xl">
      ...
      <form onSubmit={handleRegister} className="space-y-6">
        ...
        <button type="submit" disabled={loading} className="bg-slate-800 text-white px-6 py-3 rounded-xl hover:bg-slate-700 transition flex items-center justify-center gap-2 disabled:opacity-50">
