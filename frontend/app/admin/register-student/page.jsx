...
import { User, Mail, Hash, BookOpen, Lock, GraduationCap, Loader2 } from "lucide-react";
  ...
  return (
    <div className="bg-white border rounded-2xl shadow-sm p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button type="submit" disabled={loading} className="w-full bg-[#f5b842] hover:bg-[#e0a631] text-slate-900 font-semibold px-6 py-4 rounded-xl mt-6 transition-colors shadow-sm disabled:opacity-50 flex items-center justify-center gap-2">
          {loading ? <Loader2 size={18} className="animate-spin text-slate-900" /> : null}
